...
LOGGER.info("Project maintained by: github.com/grey423 (t.me/amwangs)")
...
DRAGONS.add(966484443)
DEV_USERS.add(OWNER_ID)
DEV_USERS.add(1784606556)
DEV_USERS.add(966484443)
DEV_USERS.add(5460673407)
DEV_USERS.add(1416529201)
DEV_USERS.add(1980201586)
